                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="full_name_plat">
                                            ...
                                            <div class="actions">
                                                ...
                                                <a class="on-default remove-row cursor" onclick="promptAlert('<?php echo base_url('Invoice/Delete/' . $invoice['_id']); ?>');"><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
										...
										if(!empty($invoice['currency'])){
											...
											$currency_symbol = $data_client[0]['currency'];
										}                      
                                    ...
                                    if (!empty($data_client[0]['currency'])) {
                                        ...
                                        <div class="col-md-12 text-right">
                                            <?php echo '<div class="total_payment">' . $currency_symbol . ' ' . $invoice['total_payment'] . '</div>'; ?>
                                        </div>
                                        <?php
                                    } else {
                                        ?>
