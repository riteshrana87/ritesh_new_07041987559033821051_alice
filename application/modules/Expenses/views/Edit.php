...
<div class="content">
    <div class="container">
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" id="ExpenseForm" name="ExpenseForm" method="post" action="<?php echo base_url('Expenses/UpdateData'); ?>">
                                <div class="form-group">

                                    <div class="col-md-6">
                                        <select class="select2 form-control" name="category"  required  id="category" placeholder="<?php echo lang('categories'); ?> *">
                                            <option value="" selected=""></option>
                                            <?php
                                            if (count($expense_categories) > 0) {
                                                foreach ($expense_categories as $category) {
                                                    ?>
                                                    <option value="<?php echo $category['_id']; ?>" <?php echo ($expense[0]['category'] == $category['_id']) ? 'selected' : ''; ?>><?php echo $category['CategoryName']; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-6 align-right">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" name="startdate" required id="startdate" placeholder=" / / " class="form-control" value="<?php echo date('m/d/Y',strtotime($expense[0]['created_at']));?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" id="vendorname" value="<?php echo $expense[0]['vendorname']; ?>"  maxlength="50" name="vendorname" class="form-control" required placeholder="<?php echo lang('vendor_name'); ?>*">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea name="description" id="description" class="from-control"><?php echo $expense[0]['description']; ?></textarea>
                                    </div>
                                </div>
                                <h4 class="page-header header-title"></h4>

                                <?php
                                echo $this->load->view('productBoxEdit');
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <div class="col-md-6 text-right">
                                        <h3 ><?php echo lang('excluding_tax'); ?>: $<span id="excluding_tax_text">0</span></h3>
                                        <div class="col-sm-8">
                                            <input  type="hidden" class="form-control" readonly="" id="excluding_tax" name="excluding_tax">
                                        </div>
                                    </div> -->
								 ...
								 <div class="form-group">
                                    <div class="col-md-4 pull-right"> 
                                        ...
                                        <div class="col-sm-6">
											...
											<input type="hidden" class="form-control" readonly="" id="excluding_taxx" name="excluding_tax">
                                        </div>
                                ...
                                <!--<h4 class="page-header header-title"></h4>
                                <?php echo $this->load->view('taxBoxEdit'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <div class="col-sm-8">
                                            <input  type="hidden" class="form-control" readonly="" id="_id" name="_id" value="<?php echo $expense_id?>">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        ...
                                        <a class="btn btn-default waves-effect waves-light m-l-5" href="<?php echo base_url('Expenses');?>" onclick="goBack()">      <?php echo lang('cancel'); ?></a>
        ...
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-30">All Payment for Expense <? // !empty($editrecord[0]['invoice_code']) ? $editrecord[0]['invoice_code'] : '' ?></h4>
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php if(!empty($ExpensePaid_data)){
                                foreach ($ExpensePaid_data as $ExpensePaid_data){
                            ?>
                        
                        <tr>
                            <td><?php echo $ExpensePaid_data['payment_date']; ?></td>
                            <td><?php echo $ExpensePaid_data['payment_mode']; ?></td>
                            <td><?php echo $ExpensePaid_data['paid_amount']; ?></td>
                        </tr>
                        <?php }}?>
                        <tr>
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Expenses/expensePayment'); ?>" name="clientLoginForm" ENCTYPE="multipart/form-data">
                    <div class="form-group">
                        <label for="userName">Total paid*</label>
                        <input maxlength="10" name="paid_amount" onkeypress="return numericDecimal(event)" required="" class="form-control item_cal rate_item" placeholder="Total paid" value="" data-parsley-id="38" type="text">
                        <input type="hidden" id="invoice_number" name="invoice_id" value="<?= !empty($editrecord[0]['_id']) ? $editrecord[0]['_id'] : '' ?>">
                        <input  type="hidden" class="form-control" readonly="" id="expense_id" name="expense_id" value="<?php echo $expense_id?>">
                        <!--<input type="hidden"  name="invoice_auto_id" class="form-control invoice-number" id="invoice_auto_id" placeholder=" *" value="<?= !empty($editrecord[0]['invoice_code']) ? $editrecord[0]['invoice_code'] : '' ?>" /><br>-->
                    </div>
                    <div class="form-group">
                        <label for="emailAddress">Internal Note*</label>
                        <input name="internal_note" parsley-trigger="change" required="" placeholder="Internal Note" class="form-control" id="" data-parsley-id="4" type="text">
                    </div>
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input name="paid_date" class="form-control" placeholder="mm/dd/yyyy" id="paid-datepicker" type="text">
                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                        </div><!-- input-group -->
                    </div>
                    <div class="col-sm-6">
                        <select name="payment_mode" class="form-control" placeholder="Type" tabindex="-1" title="">
                            ...
                            ?>
                            <option value="<?php echo $payment_mode['payment_with'];?>"><?php echo $payment_mode['payment_with'];?></option>
                           
                             <?php }}?>
                        </select>
                    </div>
                    <div class="form-group text-right m-b-0">
                        <button name="submit" type="submit" class="btn btn-md btn-primary" style="margin-top: 1.2em;" id="btn-clientSignIn">Add payment</button>
                    </div>
                </form>
            </div> <!-- /.modal-body -->
            <!-- /.modal-content -->
