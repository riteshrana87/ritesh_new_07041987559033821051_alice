            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                            ...
                            if (!empty($item_details)) {
                                foreach ($item_details as $row) {
                                    ...
                                    <div class="col-xs-12 col-md-12 form-group newrow" id="item_edit_<?= $row['_id'] ?>">
                                        ...
                                        <div class="col-xs-12 col-md-2">
                                            <?= !empty($row['rate']) ? $editrecord[0]['currency'].' '.$row['rate'] : '' ?>
                                        </div>
                                        <div class="col-xs-12 col-md-3">
                                        ...
                                        <div class="col-xs-12 col-md-2">
                                            <?= !empty($row['cost_rate']) ? $editrecord[0]['currency'].' '.$row['cost_rate'] : '' ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-6">
                                                <p class="text-right"><b>Excluding Tax:</b> <?= !empty($editrecord[0]['sub_price']) ? $editrecord[0]['currency'].' '.$editrecord[0]['sub_price'] : '0' ?></p>
                                                ...
                                                <p class="text-right"><b>Tax Amount:</b> <?= !empty($editrecord[0]['tax_amunt']) ? $editrecord[0]['currency'].' '.$editrecord[0]['tax_amunt'] : '' ?></p>
              ...
              <?php if (count($taxes) > 0) { ?>
                                ...
                                foreach ($taxes as $tax) {
                                    ...
                                    ?>
                            <p class="text-right <?php echo $class; ?>"><?php echo $tax["tax_name"]; ?>(<?php echo $tax["tax"]; ?>%): <?php echo $editrecord[0]['currency'].' '.$taxSum; ?></p>
                        <?php } } ?>
                            <hr>
                                                <h3 class="text-right"><?= lang('total_amount') ?>: <?= !empty($editrecord[0]['total_payment']) ? $editrecord[0]['currency'].' '.$editrecord[0]['total_payment'] : '0.00' ?></h3>
	   ...
	   <div class="col-lg-6">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                            <?php
							if(count($InvoicePaid) > 0){
								foreach($InvoicePaid as $inp){
									
									if($inp['payment_with'] == 'Ideal'){
										if($inp['ideal_status'] == 'paid'){
										?>
										<tr>
											<td> <?php echo $inp['payment_date'];  ?> </td>
											<td> <?php echo $editrecord[0]['currency'].' '.$inp['paid_amount'];  ?> </td>
							...
							<?php
									...
									echo "<td colspan='3'> No Payment History. </td>";
								}
							?>
                    </tbody>
                </table>
