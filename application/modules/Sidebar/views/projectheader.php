...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 ">
          ...
          <?php } ?>
           <?php if (checkPermission("Projectmanagement", "add")) { ?>
          <a data-href="<?php echo base_url() . 'Projectmanagement/add_record'; ?>" data-toggle="ajaxModal" class="btn btn-white">
          <?= lang('create_project') ?>
          </a>
          <?php } ?>
        </div>
...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-3 pad-tb6 dutch-custm-width-20">
    ...
    <div class="col-lg-11 col-md-11  pull-right text-right">
      <?php if (checkPermission('TeamMembers', 'add')) { ?>
