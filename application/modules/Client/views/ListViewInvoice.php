                    ...
                    <table id="tech-companies-1" class="table  table-striped">
                        ...
                        if (count($invoices) > 0) {
                            foreach ($invoices as $invoice) {
                                ?>
                                <tr>
                                    <td class="cursor_<?php echo $i; ?> cursor"><?php
                                        ...
                                        ?></td>
                                    <td class="cursor_<?php echo $i; ?> cursor"><?php echo $invoice['invoice_code']; ?></td>
                                    <td class="cursor_<?php echo $i; ?> cursor"><?php echo $invoice['amount']; ?></td>
                                    <?php /* ?><td><?php echo $invoice['total_tax']; ?></td>
                                        <td class="cursor_<?php echo $i;?> cursor"><?php echo $invoice['discount']; ?></td>
                                        <?php */ ?>
                                    <td class="cursor_<?php echo $i; ?> cursor"><?php echo $invoice['total_payment']; ?></td>
                                    <td class="cursor_<?php echo $i; ?> cursor"><?php echo $invoice['created_date']; ?></td>
                                    <td class="cursor_<?php echo $i; ?> cursor actions">
