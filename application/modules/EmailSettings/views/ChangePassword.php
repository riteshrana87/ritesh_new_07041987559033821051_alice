                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" enctype='multipart/form-data' role="form" id="ChangePasswordForm" name="ChangePasswordForm" method="post" action="<?php echo base_url('Profile/Change'); ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="current_password" name="current_password" class="form-control" placeholder="Enter Current Password" required="" parsley-trigger="change" name="nick" data-parsley-id="4">
                                        </div>
                                        <div class="form-group">
                                            <label for="pass1">Password*</label>
                                            <input type="password" class="form-control parsley-success" required="" placeholder="Password" id="pass1" name="pass1" data-parsley-id="8">
                                        </div>
                                        <div class="form-group">
                                            <label for="passWord2">Confirm Password *</label>
                                            <input type="password" id="passWord2" name="passWord2" class="form-control" placeholder="Password" required="" data-parsley-equalto="#pass1" data-parsley-id="10"><ul class="parsley-errors-list filled" id="parsley-id-10"></ul>
                                        </div>
