             ...
             ?>
                     ...
                     <?php } ?>         <div class="table-rep-plugin">
                         <div class="table-responsive" data-pattern="priority-columns">
                             <table id="stock_summary_table" class="table  table-striped">
                                 <thead>
                                     <tr>
                                         <th><?php echo lang('product');?></th>
                                        
                                          <th data-priority="1"><?php echo lang('opening_stock');?></th>
                                           <th data-priority="1"><?php echo lang('closing_stock');?></th>
                                     </tr>
                                 </thead>

                                 <tbody id="stock_summary_data">
                                     <?php 
                                        if(count($products)>0){
                                     ...
                                     <tr>
                                         ...
                                         <td><?php echo (($product['opening_stock'] != '')?$product['opening_stock']:'0');?></td>
                                         <td><?php echo (($product['closing_stock'] != '')?$product['closing_stock']:'0');?></td>
                                     </tr>
