                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" id="ExpenseForm" name="JournalForm" method="post" action="<?php echo base_url('Journals/UpdateData'); ?>">
                                <div class="form-group">

                                    <div class="col-md-6">
                                        <input type="text" id="vendorname" value="<?php echo $journal[0]['journal_code']; ?>"  maxlength="50" name="journal_code" class="form-control" required placeholder="<?php echo lang('journal_number'); ?>*" readonly>
                                        <input type="hidden" name="journal_auto_id" class="form-control journal-number" id="journal_auto_id" placeholder="*" value="<?php echo $journal[0]['journal_code']; ?>" />
                                    ...
                                    <div class="col-md-6 align-right">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" name="startdate" required id="startdate" placeholder=" / / " class="form-control" value="<?php echo date('m/d/Y',strtotime($journal[0]['created_date']));?>">
                              ...
                              <!--  <div class="form-group">
								 ...
								 <div class="form-group">
                                     <div class="col-md-8 pull-right"> 
										<div class="col-sm-3">
											Total Debit: 
                                                                                         <div class="col-sm-12">
                                                                                          $<span id="total_debit_span" name="total_debit_span"><?php echo $journal[0]['total_debit'];?></span>
											<input type="hidden"   id="total_debit" name="total_debit" value="<?php echo $journal[0]['total_debit'];?>">
                                                                                   </div>
										</div>
										...
										<div class="col-sm-3">
											Total Credit: 
                                                                                         <div class="col-sm-12">
                                                                                            $<span id="total_credit_span" name="total_credit_span"><?php echo $journal[0]['total_credit'];?></span>
                                                                                            <input type="hidden" id="total_credit" name="total_credit" value="<?php echo $journal[0]['total_credit'];?>">
                                                                                        </div>
										</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <div class="col-sm-8">
                                            <input  type="hidden" class="form-control" readonly="" id="_id" name="_id" value="<?php echo $journal_id?>">
