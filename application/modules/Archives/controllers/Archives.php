...
class Archives extends Public_controller {
    ...
    public function index($view = 'grid') {
        ...
        $url = base_url('Archives?start_rows=' . $currentPage);
...
//            die;
		...
		{
			$quantity_short = $this->input->post('quantity_short');
			...
			if(!empty($quantity_short) && !empty($perisable_short) && !empty($status_short)){
				...
				if($status_short == 'In Stock'){
					$data['products'] = $this->mongo_db->where(array('perishable' => $perisable_short))->where_ne('is_deleted',1)->where_lte('closing_stock',$quantity_short)->where_gt('closing_stock','0')->get('product');
				}
				else if($status_short == 'Out Of Stock'){
					$data['products'] = $this->mongo_db->where(array('perishable' => $perisable_short))->where_ne('is_deleted',1)->where_lte('closing_stock',$quantity_short)->where_lte('closing_stock','0')->get('product');
				}
				else{
				}
			}
				...
				if(!empty($quantity_short) && !empty($status_short)){
					$data['products'] = $this->mongo_db->where(array('perishable' => $perisable_short))->where_ne('is_deleted',1)->where_lte('closing_stock',$quantity_short)->get('product');
				}
				...
				if(!empty($quantity_short) && !empty($status_short)){
					if($status_short == 'In Stock'){
						$data['products'] = $this->mongo_db->where_lte('closing_stock',$quantity_short)->where_ne('is_deleted',1)->where_gt('closing_stock','0')->get('product');
					}
					else if($status_short == 'Out Of Stock'){
						$data['products'] = $this->mongo_db->where_lte('closing_stock',$quantity_short)->where_ne('is_deleted',1)->where_lte('closing_stock','0')->get('product');
					}
					...
					die('asd'); */
					//$data['products'] = $this->mongo_db->where_lte('closing_stock',$quantity_short)->get('product');
					$data['products'] = $this->mongo_db->where_gt('closing_stock',"$quantity_short")->where_ne('is_deleted',1)->get('product');
				}
				else if(empty($quantity_short) && !empty($status_short)){
					if($status_short == 'In Stock'){
			...
			$data['products'] =$this->mongo_db->where_lte('closing_stock','0')->where_ne('is_deleted',1)->get('product'); //$result; //$this->mongo_db->get('Client');
		/* 	echo "<pre>";
...
//            die;
    ...
    public function InsertData() {
		...
		if(!empty($this->input->post('perishable'))){
                      ...
                      //print_r($target_file);
                            ...
                            //print_r($arrayCount);
                                   ...
                                   $data = array('product_name' => (($allDataInSheet[$i]["A"] != '')?$allDataInSheet[$i]["A"]:''),
                                                ...
                                                'perishable' => (($allDataInSheet[$i]["I"] != '')?$allDataInSheet[$i]["I"]:''),
