                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="full_name_plat">
                                    <div class="full_name">
                                        <div class="project_name"><a href="<?php echo base_url('Task/'.$data['_id']);?>"><?php echo $data['projectname']; ?></a></div>
                                    </div>
                                    <div class="actions">
                                        <a class="on-default edit-row" href="#"><i class="fa fa-pencil"></i></a>
                                        <a class="on-default remove-row cursor"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
