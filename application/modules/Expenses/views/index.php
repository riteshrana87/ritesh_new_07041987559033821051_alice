<script>
	var delete_client = '<?php echo lang('expense_delete'); ?>';
	var view_name = 'List';
	var view_url = '<?php echo base_url('Expenses/Edit/');?>';
</script>
...
<div class="col-lg-10">
	<div class="row head_page">
        ...
        <div class="col-sm-2">
            <a class="btn btn-success btn-bordred page-header-btn" title="<?php echo lang('add_expense'); ?>"  href="<?php echo base_url('Expenses/Add'); ?>" type="button">
            <i class="fa fa-plus page-header-btn-icon"></i><?php echo lang('add_expense'); ?></a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="action-bar">
                    <ul class="list-inline m-b-0">
                        ...
                        <li>
                            ...
                            <a class="active" href="<?php echo base_url('Expenses/grid');?>"> <i title='<?php echo lang('gridview'); ?>' class="fa fa-file-o fa-2x cursor"></i></a>
                        </li>
                        <li>
                            <!--<i title='<?php echo lang('listview'); ?>' onclick="loadView('list', '<?php echo base_url('Expenses/'); ?>')"  class="fa fa-align-justify fa-2x cursor"></i>-->
                            <a href="<?php echo base_url('Expenses/list');?>"> <i title='<?php echo lang('gridview'); ?>' class="fa fa-align-justify fa-2x cursor"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
