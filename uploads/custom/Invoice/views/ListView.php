    ...
    foreach ($invoices as $invoice) {
		...
		/* to check Invoice Status by Dishit */
				...
				?>
                                    ...
                                    <tr>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><?php
                                            ...
                                            ?></td>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><?php echo $invoice['invoice_code']; ?></td>
                                       
                                        <?php /* ?><td><?php echo $invoice['total_tax']; ?></td>
                                        <td><?php echo $invoice['discount']; ?></td>
                                        <?php */ ?>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><?php echo $invoice['total_payment']; ?></td>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><?php echo $invoice['created_date']; ?></td>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><?php echo $invoice['due_date']; ?></td>
                                        <td class="cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" ><span class="label <?php echo $cl ?>"><?php echo $tx; ?></span></td>
                                        <td class="actions cursor_<?php echo $i;?> cursor"  onclick="view('<?php echo $invoice['_id'];?>');" >
