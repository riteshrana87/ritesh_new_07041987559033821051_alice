                            ...
                            <form class="form-horizontal" role="form" id="ExpenseForm" name="ExpenseForm" method="post" action="<?php echo base_url('Expenses/UpdateData'); ?>">
                                    ...
                                    <div class="col-md-6 align-right">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" name="startdate"   id="startdate" placeholder=" / / " class="form-control" value="<?php echo date('m/d/Y',strtotime($expense[0]['created_at']));?>">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        ...
                                        <a class="btn btn-default waves-effect waves-light m-l-5" href="<?php echo base_url('Expenses');?>">      <?php echo lang('cancel'); ?></a>
                            ...
                            <div class="card-box widget-user">
                                <div class="col-lg-10">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5"><?php echo lang('drag_reciept'); ?></h4>
                                    </div>
                                </div>
