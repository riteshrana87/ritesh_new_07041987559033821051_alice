...
<div class="col-lg-10 ">
    <div class="row">
        <div class="row">
            ...
            <div class="col-sm-2">
                <a class="btn btn-success btn-bordred waves-effect w-lg waves-light m-b-5 pull-right page-header" title="<?php echo lang('addTitleClient'); ?>"  href="<?php echo base_url('Invoice/Add'); ?>" type="button"><i class="fa fa-plus"></i> <?php echo lang('new_invoice'); ?></a>
            </div>
        </div>
        <div class="">
            ...
            <div class="action-bar pull-left">
                <ul class="list-inline m-b-0">
                    ...
                    <li>
                        <i title='<?php echo lang('gridview'); ?>' onclick="loadView('grid', '<?php echo base_url('Invoice'); ?>')" class="fa fa-file-o fa-2x"></i>&nbsp;
                    </li>
                    <li>
                        <i title='<?php echo lang('listview'); ?>' onclick="loadView('list', '<?php echo base_url('Invoice/'); ?>')"  class="fa fa-align-justify fa-2x"></i>
                    </li>
