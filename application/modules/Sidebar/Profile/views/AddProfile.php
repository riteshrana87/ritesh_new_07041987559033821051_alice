                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" enctype='multipart/form-data' role="form" id="ClientForm" name="ClientForm" method="post" action="<?php echo base_url('Profile/InsertData'); ?>">
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
                                    <div class="col-md-12">
                                        <!-- <input type="text" id="company_info"  maxlength="50" name="company_info" class="form-control" required placeholder="<?php echo lang('company_info'); ?>"> -->
										<textarea id="company_info" name="company_info" class="form-control" required placeholder="<?php echo lang('company_info'); ?>" rows="4" cols="50"><?php if(!empty($profile[0]['company_info'])){ echo $profile[0]['company_info']; } ?></textarea> 
                                    </div>
                                </div>
