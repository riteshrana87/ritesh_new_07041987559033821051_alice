    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <?php if (isset($selected_language) && $selected_language != "") { ?>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $selected_language; ?> <span class="caret"></span></a>
            <?php } else { ?>
    ...
    <div class="nav navbar-nav ">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                ...
                <li><a href="<?php echo base_url() . 'Marketingcampaign'; ?>">Marketing campaigns</a></li>
                <?php if (checkPermission ('SalesOverview', 'view')) { ?><li><a href="<?php echo base_url() . 'SalesOverview'; ?> class="<?php
               ...
               <?php if (checkPermission ('Opportunity', 'view')) { ?><li><a href="<?php echo base_url() . 'Opportunity'; ?>" class="<?php
				...
				<?php if (checkPermission ('Emailtemplate', 'view')) { ?>
					<li><a href="<?php echo base_url() . 'Emailtemplate'; ?>">Templates</a></li>
                <?php } ?>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu-Settings">
                ...
                <li><a href="<?php echo base_url('Settings/userSettings'); ?>" >User</a></li>
                <li><a href="<?php echo base_url('Settings/emailSettings'); ?>" >Email Settings</a></li>
