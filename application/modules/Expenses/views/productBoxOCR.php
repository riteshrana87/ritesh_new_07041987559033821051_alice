    ...
    foreach ($product as $prod) {
       // print_r($prod);
        ...
        <div class="form-group pdiv" id="productDiv_<?php echo $p; ?>">
            <div class="col-md-1">
                <input type="text" name="qty[]" min="0" id="qty<?php echo $p; ?>" class="form-control product_qty" placeholder="<?php echo lang('qty'); ?>" required  value="1">
            </div>
            <div class="col-md-3">
                <input type="text" name="product_name[]" id="product_name<?php echo $p; ?>" class="form-control product_name_class" placeholder="<?php echo lang('product_name'); ?>" value="<?php echo $prod[0]; ?>" required >
            ...
            <div class="col-md-2">
                <input type="text" name="product_price[]" min="0" maxlength="6" id="product_price<?php echo $p; ?>" onkeypress="return numericDecimal(event)" class="form-control product_price" data-inc="<?php echo $p; ?>" value="<?php echo $prod[1]; ?>" placeholder="<?php echo lang('price'); ?>" data-parsley-pattern="/^\d{0,8}(\.\d{0,2})?$/" required >
            </div>
            <?php if ($p > 0) { ?>
                <div class="col-md-1">
