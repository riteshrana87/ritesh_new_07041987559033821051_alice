...
<tr>
<th class="table-header-repeat line-left minwidth-1"><a href=""><?php echo lang('title');?></a></th>
<th class="table-header-repeat line-left minwidth-1"><a href=""><?php echo lang('catagories');?></a></th>
<th class="table-header-repeat line-left minwidth-1"><a href=""><?php echo lang('feature_image');?></a></th>
<th class="table-header-repeat line-left"><a href=""><?php echo lang('EST_TITLE_AUTOGRAPH_DATE');?></a></th>
<th class="table-header-options line-left"><a href=""><?php echo lang('actions');?></a></th>
</tr>
<?php
$count = count($user);
for($i = 0;$i< $count;$i++)
