...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="add_client_header">Create Invoice</div>
        <form id="from-model" method="post" action="<?php echo base_url('Invoice/insertdata'); ?>" name="frmsubmit" class="frmsubmit" enctype="multipart/form-data" data-parsley-validate>
            <div class="panel panel-default panel_invoice">
                ...
                <div class="panel-body">
                    <div class="top_section">
                        ...
                        <div class="address">
                            <?php if (!empty($CompanyInformation)) { ?>
                                <div class="comp_name"><?php echo ucfirst($CompanyInformation[0]['company']); ?></div>
                                <div class="address_detail"><?php echo $CompanyInformation[0]['address']; ?></div>
                                <div class="zip_detail"><?php echo $CompanyInformation[0]['zipcode']; ?></div>
                                <abbr title="Phone">Ph:</abbr> <?php echo $CompanyInformation[0]['phone']; ?>
                    ...
                    <div class="section_one">
                        <div class="section_one_left">
                            <div class="select_box">
                                <?php
                                /* if(!empty($selected_client)){ echo $selected_client."<br>"; } if(!empty($selected_client_details)){print_r($selected_client_details);} */
                                ?>
                            ...
                            <div class="address" id="client_detail">
                                <?php
                                if (!empty($selected_client))
                                {
                                    ?>
                                    <div class="comp_name" id="full_name"><?php echo $selected_client_details[0]['firstname'] . $selected_client_details[0]['lastname']; ?></div>
                                    <div class="address_detail" id="addreaa"><?php echo $selected_client_details[0]['address']; ?></div>
                                    <div class="city_detail" id="zip_city"><?php echo $selected_client_details[0]['zipcode'] . ',' . $selected_client_details[0]['city']; ?></div>
                                    <div class="state_count" id="state_count"><?php echo $selected_client_details[0]['state'] . ',' . $selected_client_details[0]['country']; ?></div>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <div class="section_one_right">
                            <input type="hidden" name="hdn_submit_status" id="hdn_submit_status" value="1"/><input type="hidden" name="HdnSubmitBtnVlaue" id="HdnSubmitBtnVlaue" value="save"/><input type="hidden" name="HdnChangeEmailTmp" id="HdnChangeEmailTmp" value="no"/><input type="hidden" id="delete_item_id" name="delete_item_id" value=""><input type="hidden" id="invoice_id" name="invoice_id" value="<?= !empty($editrecord[0]['_id']) ? $editrecord[0]['_id'] : '' ?>"><input type="hidden" name="invoice_auto_id" class="form-control" id="invoice_auto_id" placeholder=" *" value="<?= !empty($editrecord[0]['invoice_code']) ? $editrecord[0]['invoice_code'] : $invoice_auto_id ?>" readonly/>
                            <div class="section_one_plat">
                                <div class="plat1"><span class="plat1_invoice">Invoice Number:</span></div>
                                <div class="plat2"><input type="text" name="invoice_auto_id" class="form-control invoice-number" id="invoice_auto_id" placeholder="*" value="<?= !empty($editrecord[0]['invoice_code']) ? $editrecord[0]['invoice_code'] : $invoice_auto_id ?>" readonly/></div>
                            </div>
                            <div class="section_one_plat">
                                <div class="plat1">Date of Issue:</div>
                                <div class="plat2"><input type="text" name="created_date" class="form-control invoice-datepicket" placeholder="mm/dd/yyyy" id="datepicker-customrem" value="<?= !empty($editrecord[0]['created_date']) ? $editrecord[0]['created_date'] : date("m/d/Y") ?>"></div>
                            </div>
                            <div class="section_one_plat">
                                <div class="plat1">Due Date:</div>
                                <div class="plat2"><input type="text" name="due_date" class="form-control invoice-datepicket" placeholder="mm/dd/yyyy" id="datepicker-due" value="<?= !empty($editrecord[0]['created_date']) ? $editrecord[0]['created_date'] : date("m/d/Y") ?>"></div>
                            </div>
                        </div>
                    </div>
                    <div class="section_two">
                        <div class="box_head">Summary</div>
                        ...
                        <div class="form-group">
                            <div class="form-group row" id="add_items">
                                <div class="col-xs-12 col-md-12 visible-lg visible-md">
                                    <div class="col-xs-12 col-md-1 add_items_heading">
                                        <label><?= lang('qty_hrs') ?> <span class="viewtimehide">*</span></label>
                                    </div>
                                    <div class="col-xs-12 col-md-2 add_items_heading">
                                        <label><?= lang('product_name') ?> <span class="viewtimehide">*</span></label>
                                    </div>
                                    <div class="col-xs-12 col-md-2 add_items_heading">
                                        <label><?= lang('description') ?> <span class="viewtimehide"></span></label>
                                    </div>
                                    <div class="col-xs-12 col-md-2 add_items_heading">
                                        <label><?= lang('rate') ?> <span class="viewtimehide">*</span></label>
                                    </div>
                                    <!-- <div class="col-xs-12 col-md-2">Type</div> -->
                                    <div class="col-xs-12 col-md-2 add_items_heading">
                                        <label><?= lang('tax_rate') ?>(%)</label><span class="viewtimehide"></span>
                                    </div>
                                    <div class="col-xs-12 col-md-2 add_items_heading">
                                        <label><?= lang('amount') ?></label>
                                    </div>
                                    <div class="col-xs-12 col-md-1 add_items_heading">
                                        <label><?= lang('actions') ?></label>
                                    </div>
                                </div>
                                <?php
                                if (!empty($item_details)) {
                                    foreach ($item_details as $row) {
                                        ...
                                        <div class="col-xs-12 col-md-12 form-group newrow" id="item_edit_<?= $row['_id'] ?>">
                                            <div class="col-xs-12 col-md-1 add_items_field">
                                            ...
                                            <div class="col-xs-12 col-md-2 add_items_field">
                                                ...
                                                <span class="empty-message">Please Enter Product</span>
                                            </div>
                                            <div class="col-xs-12 col-md-2 add_items_field">
                                            ...
                                            <div class="col-xs-12 col-md-3 add_items_field">
                                                <select class="form-control item_cal tax_item select_field" name="tax_rate_<?= $row['_id'] ?>">
                                            ...
                                            <div class="col-xs-12 col-md-1 add_items_field">
                                                <a class="pull-right btn btn-default">
                                                    <span class="glyphicon glyphicon-trash" onclick="delete_item_row('item_edit_<?= $row['_id'] ?>');"></span>
                                                </a>
                                            </div>
                                        </div>
                                        <?php
                    ...
                    <div class="section_five">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 col-md-offset-2">
                            <strong style="padding-left:10px;">Excluding Tax: </strong>
                            <input type="text" name="sub_price" class="form-control invoice-number" id="sub_price" placeholder="0" value="<?= !empty($editrecord[0]['sub_price']) ? $editrecord[0]['currency'].' '.$editrecord[0]['sub_price'] : '0' ?>" data-parsley-id="6" readonly="">
                            <br/>
                            <div class="input-group">
                            ...
                            <input type="hidden" name="discount_type" id="discount_type" value="<?= !empty($editrecord[0]['discount_type']) ? $editrecord[0]['discount_type'] : '1' ?>">
                            <br/>
                            <strong style="padding-left:10px;line-height:37px;">Tax Amount:</strong>
                            <input type="text" name="tax_amunt" class="form-control invoice-number" id="tax_amunt" placeholder="0" value="<?= !empty($editrecord[0]['tax_amunt']) ?  $editrecord[0]['currency'].' '.$editrecord[0]['tax_amunt'] : '' ?>" data-parsley-id="6">
                            <hr>
                            ...
                            <?php if (count($taxes) > 0) { ?>
                                ...
                                foreach ($taxes as $tax) {
                                    ...
                                    ?>
                                    <p class="text-right <?php echo $class; ?> tax_boxvals" id="tax_<?php echo $tax["_id"]; ?>"><?php echo $tax["tax_name"]; ?> (<?php echo $tax["tax"]; ?>%): <span id='<?php echo $tax["_id"]; ?>' class="tax_boxvals_item"><?php echo  $editrecord[0]['currency'].' '.$taxSum; ?></span></p>
                                    <?php
                                }
                            }
                            ?>
                            <p class="text-right">
                                <b><label class="control-label"><?= lang('total_amount') ?> : <span id="total_item"><?= !empty($editrecord[0]['total_payment']) ?  $editrecord[0]['currency'].' '.$editrecord[0]['total_payment'] : '0.00' ?></span></label></b>
                    ...
                    <div class="section_six">
                        <div class="box_head">Terms And Conditions</div>
    ...
    <div class="col-lg-3">
        <div class="card-box right_side_form">
            <div class="row">
                <div class="col-md-4"><a href="javascript:;" class="btn btn-primary waves-effect waves-light top_btn" onclick="SaveInvoiceForm('save');"><i class="fa fa-cloud m-r-5"></i>Save</a></div>
                <div class="col-md-4"><a href="javascript:;" class="btn btn-primary waves-effect waves-light top_btn" onclick="emailTemplatePopup();"><i class="fa fa-envelope-o m-r-5"></i>Send</a></div>
                <div class="col-md-4"><a href="javascript:;" class="btn btn-primary waves-effect waves-light top_btn" onclick="SaveInvoiceForm('print');"><i class="fa fa-save m-r-5"></i>Print</a></div>
            </div>
            <h4 class="header-title m-t-20 m-b-30"><?php echo lang('setting_for_this_invoice'); ?></h4>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default bx-shadow-none">
                        <div class="panel-heading" role="tab" id="headingOne">
                            ...
                            <div class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><?php echo lang('setting_for_this_invoice'); ?></a>
                            </div>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <h4 class="m-t-0 page-header header-title"><i class="fa fa-money" style="padding-right:5px;"></i><b><?php echo lang('add_payment_option'); ?></b></h4>
                                STRIPE<br>
                                <small>
                                    Stripe is an easy way to accept payment online simple pricing with no hidden or monthly costs:2.9% + $0.30 per transaction Accept all major cards and currencies:Visa ,mastercard, Amex,Discover
                                ...
                                <div><a href="javascript:void(0)" id="stripe_call" style="float:right;" class="btn btn-success waves-effect waves-light btn-sm m-b-5">Connect With Stripe</a></div>
                                ...
                                <!--  <a href="#"> -->
                                IDEAL<br>
                                <small>iDEAL is an e-commerce payment system based on online banking Only$0.29 per transaction</small>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-5	 col-sm-12">
                                                <button name="strip_submit" id="strip_submit" class="btn btn-primary waves-effect waves-light" type="button"> <?php echo lang('save'); ?> </button>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                </div>
                                ...
                                <div class="paypal_form_container">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-5	 col-sm-12">
                                                <button name="paypal_submit" id="paypal_submit" class="btn btn-primary waves-effect waves-light" type="button"> <?php echo lang('save'); ?> </button>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                </div>
                                <div class="ideal_form_container">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-5	 col-sm-12">
                                                <button name="ideal_submit" id="ideal_submit" class="btn btn-primary waves-effect waves-light" type="button"> <?php echo lang('save'); ?> </button>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                </div>
                    ...
                    <div class="panel panel-default bx-shadow-none">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            ...
                            <div class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"><?php echo lang('make_recuring'); ?></a>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-info">
                                        <div style="width: 43%;">
                                            ...
                                            <label for="radio5"> <?php echo lang('recurring10'); ?> </label>
                                        </div>
                                        <div style="width: 43%;">
                                            <input type="radio" name="howmany" id="radio6" value="1" data-parsley-mincheck="1" required>
                                            <label for="radio6"> <?php echo lang('recurring11'); ?> </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-info">
                                        <div>
                                            ...
                                            <label for="radio7"> <?php echo lang('recurring13'); ?> </label>
                                        </div>
                                        <div>
                                            <input type="radio" name="delivery" id="radio8" value="1" data-parsley-mincheck="1" required>
                                            <label for="radio8"> <?php echo lang('recurring14'); ?> </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-default bx-shadow-none">
                        <div class="panel-heading" role="tab" id="headingThree">
                            ...
                            <div class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree"><?php echo lang('send_reminders'); ?></a>
                            </div>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-offset-3	 col-sm-12">
                                    <button name="create_reminder" id="create_reminder" class="btn btn-primary waves-effect waves-light create_reminder" type="button"><?php echo lang('create_reminder'); ?></button>
                                </div>
                    ...
                    <div class="panel panel-default bx-shadow-none">
                        <div class="panel-heading" role="tab" id="headingFour">
                            ...
                            <div class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseFour"><?php echo lang('currency_language'); ?></a>
                            </div>
                        </div>
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body" id="rightinvoice">
                                ...
                                <div class="curlang">
                                    ...
                                    <button id="invoice_langcurr" type="button" class="btn btn-custom waves-effect waves-light">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <form class="form-horizontal" role="form" id="ProductForm" name="ProductForm" method="post" action="<?php echo base_url('Product/InsertData'); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div id="useble_div">
                                                        <label style="float:left"> Useable up to </label>
                                                        <input type="text" onkeypress="return numericDecimal(event)" style="width:20%; float:left; margin:0px 10px;" id="useable_days" name="useable_days" class="form-control"> <label style="float:left">Days</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-4 col-sm-8">
                                                    <button name="submit" id="submit" class="btn btn-primary waves-effect waves-light" onclick="add_product()" type="button"><?php echo lang('product_add'); ?></button>
                                                    <button class="btn btn-default waves-effect waves-light m-l-5" data-dismiss="modal" onclick="goBack()" type="reset">Cancel</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div><!-- end col -->
