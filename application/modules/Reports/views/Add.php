                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" id="ExpenseForm" name="ExpenseForm" method="post" action="<?php echo base_url('Expenses/InsertData'); ?>">
                                         ...
                                         <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" name="startdate"   id="startdate" placeholder=" / / " class="form-control" value="<?php echo date('m/d/Y');?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" id="vendorname"  maxlength="50" name="vendorname" class="form-control" required placeholder="<?php echo lang('vendor_name'); ?>*">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                ...
                                <?php echo $this->load->view('productBox'); ?>
