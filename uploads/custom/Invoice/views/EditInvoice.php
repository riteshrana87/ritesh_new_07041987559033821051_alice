...
<div class="row">
    ...
    <div class="col-lg-3">
        ...
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-30">All Payment for invoice <?= !empty($editrecord[0]['invoice_code']) ? $editrecord[0]['invoice_code'] : '' ?></h4>
    ...
    <?php } ?>
        ...
        <div id="toggleText" style="display: none" class="card-box">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('Invoice/invoicePayment'); ?>" name="clientLoginForm" ENCTYPE="multipart/form-data">
    ...
    <form id="from-model" method="post"  action="<?php echo base_url('Invoice/insertdata'); ?>" name="frmsubmit" class="frmsubmit" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="col-lg-8">
                                <div class="pull-left m-t-30" id="client_detail">
                                    <?php if(!empty($invoice_client_data)){?>
                                     <strong id="full_name" style="padding-left:10px;"><?php echo $invoice_client_data[0]['firstname'] .' '. $invoice_client_data[0]['lastname'] ; ?></strong><br />
                                            <strong id="addreaa" style="padding-left:10px;"><?php echo $invoice_client_data[0]['address']; ?></strong><br />
                                            <strong id="zip_city" style="padding-left:10px;"><?php echo $invoice_client_data[0]['zipcode'] .','. $invoice_client_data[0]['city']; ?></strong><br />
                                            <strong id="state_count" style="padding-left:10px;"><?php echo $invoice_client_data[0]['state'] .','. $invoice_client_data[0]['country']; ?></strong>  
                                    <?php } ?>
                                </div>
                            </div>
      ...
      <!--<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" value="<?= !empty($editrecord[0]['created_date']) ? $editrecord[0]['created_date'] : date("m/d/Y") ?>">-->
                                    ...
                                    <input type="text" name="due_date" class="form-control invoice-datepicket" style="width:50%;float:right;height:20px;" placeholder="mm/dd/yyyy" id="datepicker-due" value="<?= !empty($editrecord[0]['due_date']) ? $editrecord[0]['due_date'] :'' ?>"><br>
                                ...
                                foreach ($item_details as $row) {
                                    ...
                                    <div class="col-xs-12 col-md-12 form-group newrow" id="item_edit_<?= $row['_id'] ?>">
                                        <div class="col-xs-12 col-md-1">
                                         ...
                                         <div class="col-xs-12 col-md-2">
                                             <input type="text" id="product_name" name="product_name_<?= $row['_id'] ?>" maxlength="40" class="form-control product_name_class" placeholder="" required value="<?php echo productName($row['product_id']);?>">
                                             <span class="empty-message" style="display:none; color: red">Please seletct a Product</span>
                                         </div>
                                        <div class="col-xs-12 col-md-2">
                                            <input type="text" name="description_<?= $row['_id'] ?>" maxlength="80" class="form-control description_class" placeholder="" required value="<?= !empty($row['description']) ? $row['description'] : '' ?>">
                                        </div>
                                        <div class="col-xs-12 col-md-2">
                            ...
                            <br /><br />
                                                    <div class="input-group">
                                                        <div class="input-group-btn">
                                                            <button type="button" class="btn waves-effect waves-light btn-primary dropdown-toggle" data-toggle="dropdown" style="overflow: hidden; position: relative;" id="discounttype">
                                                            ...
                                                            <ul class="dropdown-menu discountval">
                                                                <li><a class="active" href="javascript:void(0)" id="percent">Percentage(%)</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input class="form-control" name="invoice_id" id="invoice_id" type="hidden" value="<?= !empty($editrecord[0]['_id']) ? $editrecord[0]['_id'] : '' ?>" />
	  ...
	  <div class="modal-footer">
        <center>
		  ...
		  <input type="submit" value="<?php echo lang('EST_EDIT_SAVE');?>" name="submit" class="btn btn-info">
        </center>
      </div>
      </form>
       <!--<div class="modal-footer">
